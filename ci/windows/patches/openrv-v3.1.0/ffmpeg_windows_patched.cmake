...
EXTERNALPROJECT_ADD(
  ...
  CONFIGURE_COMMAND
    ${CMAKE_COMMAND} -E env "PKG_CONFIG_PATH=${_ffmpeg_pkg_config_path}" "PKG_CONFIG_LIBDIR=${_ffmpeg_pkg_config_path}" "PKG_CONFIG_DIR=" "CL=" "MSYS2_ARG_CONV_EXCL=/FS" ${_configure_command} --prefix=${_install_dir} ${RV_FFMPEG_COMMON_CONFIG_OPTIONS}
